...
namespace Ayudantia.Src.Data.Migrations
{
    ...
    [Migration("20250628162810_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ayudantia.Src.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Ayudantia.Src.Models.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Ayudantia.Src.Models.Order", b =>
                {
                    b.HasOne("Ayudantia.Src.Models.ShippingAddres", "ShippingAddress")
                        .WithMany()
            ...
            modelBuilder.Entity("Ayudantia.Src.Models.OrderItem", b =>
                {
                    b.HasOne("Ayudantia.Src.Models.Order", "Order")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Ayudantia.Src.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
